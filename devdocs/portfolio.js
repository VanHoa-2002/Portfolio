...
const greeting = {
  username: "Hoà Dev",
  title: "Hi all, I'm Hoà",
  subTitle: emoji(
    "A passionate Frontend Developer with 2 years of experience, currently building scalable web applications using Angular. 🚀 Skilled in JavaScript, TypeScript, RxJS, NgRx, and integrating RESTful APIs."
  ),
  resumeLink:
    "https://drive.google.com/file/d/1IktKCNowi-jJkF92T6ZT1Fy0F4MpEtTk/view?usp=sharing", // Set to empty to hide the button
...
const skillsSection = {
  title: "What I do",
  subTitle:
    "A FRONTEND DEVELOPER SPECIALIZING IN ANGULAR, EAGER TO EXPLORE AND MASTER MODERN WEB TECH STACKS. SKILLED IN FRONTEND AND BACKEND DEVELOPMENT, RESTFUL API INTEGRATION, AND SCALABLE ARCHITECTURE.",
  skills: [
    emoji(
      "⚡ Dream architect and design mobile applications that provide relentless pursuit to craft innovative solutions"
    ),
...
const bigProjects = {
  ...
  projects: [
    {
      image:
        "https://play-lh.googleusercontent.com/f34ycdXzkIMYwDEgloU1BVt0Ug1EZbpuaEeraXhJT0N8sjbkkLnAJOIT6D-i0-yBFw8=w480-h960-rw",
      projectName: "Crunch Africa (iOS,Android)",
      projectDesc:
        "Fintech App, Mobile App Architect,Flutter UI, Bloc,QrCode Firebase Auth, Sentery, Unit, Widget and Integration Testing",
      footerLink: [
        {
          name: "AppStore",
    ...
    {
      image:
        "https://is5-ssl.mzstatic.com/image/thumb/Purple116/v4/31/3b/ad/313bad13-bc45-8529-ff0b-141a1634fd72/AppIcon-akyurt-0-0-1x_U007emarketing-0-0-0-7-0-0-sRGB-0-0-0-GLES2_U002c0-512MB-85-220-0-0.png/460x0w.webp",
      projectName: "Akyurt Online (iOS, Android)",
      projectDesc:
        "Provider, Complex UI, Backend Api services Integration, Payment Integration",
      footerLink: [
        {
          name: "App Store link",
    ...
    {
      image:
        "https://play-lh.googleusercontent.com/D1QMd1lBE0IEDfixVo03EZd-TMwFS6N0NcMCYGqWlbXok8lPkrhM-9eBQp6LH_lAd_I=w480-h960-rw",
      projectName: "Baredex",
    ...
    {
      image:
        "https://play-lh.googleusercontent.com/sJAoXHEDWSvSV94ukJca-WxCLZaNLmbcFjK-QggNxQT7bgHL2VWrj10VoZ5BBA-ZLQ=w480-h960-rw",
      projectName: "Mocowi",
      projectDesc:
        "Internet of things Card device App, Rest Apis, real time data",
      footerLink: [
        {
          name: "PlayStore",
    ...
    },
    {
      ...
      projectName: "Sabroso",
      projectDesc:
        "Bloc State Management, Cart checkout and payment System, Unit,,widget and integration testing",
      footerLink: [
        {
          name: "PlayStore",
          url: "#",
  ...
  achievementsCards: [
    {
      ...
      subtitle:
        "Front-End Web UI Frameworks and Tools,BootStrap, Angular,Ionic and Cordova, Server-side Development with NodeJS, Express and MongoDB",
      image: require("./assets/images/HKUST-original_0.svg"),
      footerLink: [
        {
          name: "Specialization Certification",
          url: "https://www.coursera.org/account/accomplishments/specialization/E2FUUDKBDZ5P",
        },
      ],
    },
    {
      ...
      subtitle:
        "Front-End Web UI Frameworks and Tools,React, React Native,Server-side Development with NodeJS, Express and MongoDB",
      image: require("./assets/images/coursera.svg"),
      footerLink: [
        {
          name: "Specialization Certification",
          url: "https://www.coursera.org/account/accomplishments/specialization/2FGBCJUE5DJZ",
        },
      ],
    },
    {
  ...
  blogs: [
    {
      ...
      description:
        "While programming any software, there is always, needed some values to have a fixed value that can not be changed once assigned the value. Dart provides two keywords for defining constant values const and final.",
    },
    {
      ...
      description:
        "In strongly typed Programming languages there is needed for type conversion to use a string value as a number. As a Flutter developer, my interest is in Dart to make heart Flutter :)",
    },
  ],
  display: true, // Set false to hide this section, defaults to true
};
